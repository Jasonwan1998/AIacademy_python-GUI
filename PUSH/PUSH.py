...
table = {1:"Ecryption", 2:"PUID", 3:"Port", 4:"Status"}
...
photo_progress = tk.PhotoImage(file = "progress2.png")
...
label_title1 = tk.Label(master = frame_bar, text = "Select File (s): ", bg = "white")
label_title2 = tk.Label(master = frame_bar, text = "Output Folder: ", bg = 'white')
label_title3 = tk.Label(master = frame_bar, text = "Destionation Folder: ", bg = 'white')
...
select_file = tk.Entry(master = frame_bar, width = 65)
output_folder = tk.Label(master = frame_bar, width = 65, text = 'G:\CitiFile' )
destionation_folder = tk.Label(master = frame_bar, width = 65, text=" Citi")
select_file.grid(row = 0, column = 1, sticky = 'nw')
output_folder.grid(columnspan = 2, row = 1, column = 1, sticky = 'w')
destionation_folder.grid(columnspan = 2, row = 2, column = 1, sticky = 'w')
...
photo_convert = tk.PhotoImage(file = "PUSH.png")
...
results = tk.Label(master = frame_centre_content, height = 20, width = 100, text = " PUSH log. Progress Sucessful or fail")
...
table_input = tk.Button(master = frame_table, text = "G:\CitiFiles\Output\WLPMT010720.txt", width = 80)
table_input.grid(columnspan = 5, row = 1, column = 1, sticky = 'nw', pady = 5)

table_output = tk.Button(master = frame_table, text = "G:\CitiFiles\H2H\WLPMT010720.zip", width = 80)
